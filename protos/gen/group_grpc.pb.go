...
type GroupServiceClient interface {
	...
	DeleteGroup(ctx context.Context, in *DeleteGroupRequest, opts ...grpc.CallOption) (*EmptyGroup, error)
}
...
func (c *groupServiceClient) DeleteGroup(ctx context.Context, in *DeleteGroupRequest, opts ...grpc.CallOption) (*EmptyGroup, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(EmptyGroup)
...
type GroupServiceServer interface {
	...
	DeleteGroup(context.Context, *DeleteGroupRequest) (*EmptyGroup, error)
...
func (UnimplementedGroupServiceServer) DeleteGroup(context.Context, *DeleteGroupRequest) (*EmptyGroup, error) {
